      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Card className="h-full bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-gray-700 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <Grid item xs={12} md={8}>
            <Grid container spacing={4}>
              ...
              <Grid item xs={12}>
                <Card className="bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-gray-700 rounded-2xl shadow-xl">
              ...
              <Grid item xs={12} md={6}>
                <Card className="h-full bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-gray-700 rounded-2xl shadow-xl">
                  <CardContent className="p-6">

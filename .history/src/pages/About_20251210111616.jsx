...
export default function About() {
  ...
  return (
    <Box className="min-h-screen bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] py-16 px-4">
      <Container maxWidth="xl">
        ...
        {/* <-- FIX: alignItems="flex-start" to align top of left & right columns --> */}
        <Grid container spacing={4} alignItems="flex-start">
          
          {/* <-- FIX: xs changed from 10 -> 12 so it stacks predictably on small screens --> */}
  ...
  >
    ...
    >
      ...
      <Typography 
        variant="h4" 
        className="font-bold text-center mb-2 text-cyan-400"
        ...
        <Box className="flex items-center">
          ...
          <Grid item xs={12} md={8}>
            <Grid container spacing={4}>
              ...
              <Grid item xs={12}>
                {/* <-- FIX: add h-full so this card's top aligns with left card --> */}
                <Card sx={gradientBorderStyle} className="h-full bg-[#0f172a] shadow-xl">
                  <CardContent className="p-6">
                    {/* <-- conservative responsive heading size to avoid too-large fonts --> */}
                    <Typography 
                      variant="h4" 
                      className="font-bold mb-4 text-cyan-400"
                      sx={{ fontSize: { xs: "1.25rem", md: "1.6rem" } }}
                    >
                      Professional Summary
                    </Typography>
                    <Typography 

  ...
  return (
    ...
    >
      ...
      >
        ...
        size="medium"
        href="#projects"
        className="!bg-gradient-to-r !from-azure-500 !to-blue-600 !rounded-full px-8 py-3 !text-lg !font-semibold !normal-case shadow-lg hover:shadow-cyan-500/25 transition-all duration-300 w-full sm:w-auto text-center"

      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={4}>
            <Paper className="p-6 bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-gray-700 rounded-xl text-center shadow-xl">
              <Avatar
                sx={{
                  width: 150,
                  height: 150,
          ...
          <Grid item xs={12} md={8}>
            ...
            <Paper className="p-6 bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-gray-700 rounded-xl mb-6 shadow-xl">
            ...
            {/* Certifications */}
            <Paper className="p-6 bg-gradient-to-b from-[#1e293b] to-[#0f172a] border border-gray-700 rounded-xl shadow-xl">
              <Typography variant="h5" className="font-bold mb-4 text-cyan-400 flex items-center">

              ...
              {menuItems.map((item) => (
                <Button
                  ...
                  startIcon={React.cloneElement(item.icon, {
                    sx: activeItem === item.name ? gradientStyle : { color: "#d1d5db" }
                  })}
                  className="font-medium flex items-center transition-all duration-300"
                  sx={{
                    color: activeItem === item.name ? 'transparent' : "#d1d5db",
                    '&:hover': gradientStyle,
                    ...(activeItem === item.name && gradientStyle)
                  }}
                >
                  {item.name}
                </Button>
          ...
          {menuItems.map((item) => (
            <ListItem 
              ...
              sx={{
                ...
                margin: "4px 8px",
                borderRadius: "8px",
                color: activeItem === item.name ? 'transparent' : "#e2e8f0",
                '&:hover': {
                  backgroundColor: "rgba(255, 255, 255, 0.1)",
                },
                ...(activeItem === item.name && gradientStyle)
            ...
            >
              <ListItemIcon sx={{ 
                ...
                {React.cloneElement(item.icon, {
                  sx: activeItem === item.name ? gradientStyle : { color: "inherit" }
                })}
              </ListItemIcon>
              <ListItemText 
                primary={item.name} 
